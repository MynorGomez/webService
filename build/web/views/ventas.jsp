...
<head>
    ...
    <style>
        ...
        .content-wrapper { margin-left: 115px; padding: 30px; min-height: 100vh; }
        .card {
            border: none;
            border-radius: 10px;
            overflow: hidden;
...
<div class="content-wrapper">
    <div class="card">
        ...
        <div class="card-body">
                ...
                %>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <!-- ? Generar PDF -->
                                    <a href="../FacturaPDF?idVenta=<%= rs.getInt("idVenta") %>" 
                                       class="btn btn-danger btn-sm" 
                                       target="_blank" title="Generar factura PDF">
            ...
            %>
                <div class="alert alert-info mt-3"><i class="bi bi-pencil"></i> Venta actualizada correctamente.</div>
            <%
                } else if ("deleted".equals(msg)) {
            %>
                <div class="alert alert-warning mt-3"><i class="bi bi-trash"></i> Venta eliminada correctamente.</div>
            <%
                }
            %>
        </div>
